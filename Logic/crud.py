...
def adaugare(lst_cheltuieli, nr_ap, suma, data, tip):
    '''
...
def stergere(lst_cheltuieli, nr_ap):
    '''
    Sterge din lista cheltuiala cu un numar de apartament dat
    :param lst_cheltuieli: O lista de cheltuieli
    :param nr_ap: Numar de apartament dat
...
def modif(lst_cheltuiali, new_cheltuiala):
    '''
    Functia modifica (inlocuieste) cheltuiala pentru un anumit nr de aprtament cu o alta
...
def read(lst_cheltuieli, nr_ap_cheltuiala = None):
    '''
    Functia verifica daca apare in lista de cheltuieli o anumita cheltuiala, cu nr_apartament dat
    :param lst_cheltuieli:O lista de cheltueieli
    :param nr_ap_cheltuiala:Numarul apartamentului a cheltuielii
    ...
    for cheltuiala in lst_cheltuieli:
        if get_nr_ap(cheltuiala) == nr_ap_cheltuiala: #am gasit cheltuiala
